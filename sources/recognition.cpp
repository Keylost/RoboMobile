...
uint32_t ANGLE_CENTER = 90; //угол сервомотора, при котором колеса робота смотрят прямо
uint32_t ANGLE_RANGE = 35; //максимальное отклонение сервомотора от центрального положения
uint32_t MAX_SPEED = 990; //максимальная скорость движения в условных единицах (от 0 до 999)
uint32_t MIN_SPEED  = 450; //минимальная скорость движения в условных единицах (от 0 до 999)
...
int32_t ANGLE_MIN = ANGLE_CENTER - ANGLE_RANGE;
int32_t ANGLE_MAX = ANGLE_CENTER + ANGLE_RANGE;
